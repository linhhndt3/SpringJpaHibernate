...
@Repository("userProfileDaoV2")
public class UserProfileDaoV2Impl extends AbstractJpaDao<Integer, UserProfile> implements UserProfileDao{
 
	public UserProfileDaoV2Impl() {
		System.out.println("init user v2");
	}
